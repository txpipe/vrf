...
the repo is going to support it.
...
(according to the draft standards 10). This does not reduce the security of the scheme, but makes it incompatible with other
implementations.
